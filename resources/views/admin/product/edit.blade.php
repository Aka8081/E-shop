...
<div class="card">
    ...
    <div class="card-body">
        <form action="/edit-products/{{$products->id}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea name="description" rows="3" class="form-control">"{{ $products->textarea }}"</textarea>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" value="{{ $products->Quantity }}" class="form-control" name="qty">
                </div>
